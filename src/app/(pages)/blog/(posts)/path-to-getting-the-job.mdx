...
In a world where cold outreach is becoming increasingly ineffective, showing your impact on the community represents a harder but more certain path. And as I've discussed in [the first article](https://subbyte.net/blog/prepare-yourself), getting these types of opportunities is easier when you create valuable connections with people who share similar interests.
...
- [Pirate Software:  Resume and Cover Letter](https://youtu.be/Di5Q35-t4A4)
